		 	...
		 	<fieldset>
        		...
        		<div id="verify_teacher_section" style="margin-left:13px;">
	        		...
	        		<div style="margin-left:13px;" id="external_teacher_list_section">
	        			...
	        			<input type="text" class="pure-u-1-6" id="url" name="URL">
	        			</p>
		 				<p>
	        			<label style="text-align:center;" for="form" class="pure-u-1-24">Form</label>
	        			<input type="text" class="pure-u-1-6" id="form" name="form">
	        			</p>
	        		</div>
        		</div>
        		<br/>
        		<input class="pure-button pure-button-active" type="submit" value="Create" name="submit">
		 	</fieldset>
		 </form>
		 
		 <div style="border:1px solid black; margin:15px; height:50px;" class="pure-u-1-2">
		 	<div style="margin:12px;"><a href="${sessionScope.generic_link }" target="_blank">${sessionScope.generic_link }</a></div>
		 </div>
	</div>
</div>
</body>
